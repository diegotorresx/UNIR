...
#Código nuevo para comprobar cambiod e comportamiento en hurística caso 3

print ("Heurística 1 con cambios en mapa\n")
main (MAP_ASCII_TEST_CASE3,COSTS,algorithms,1)
print ("Heurística 2 con cambios en mapa\n")
main (MAP_ASCII_TEST_CASE3,COSTS,algorithms,2)
print ("Heurística 3 con cambios en mapa\n")
main (MAP_ASCII_TEST_CASE3,COSTS,algorithms,3)